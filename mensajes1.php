...
<body>
    ...
    <main id="main">
        ...
        <?php
            ...
            if(isset($_POST['asunto']) && isset($_POST['cuerpo']) && isset($_SESSION['id']) && isset($_SESSION['username']) && isset($_POST['fecha'])){
               
                $asunto = filter_var($_POST['asunto'], FILTER_SANITIZE_STRING);
                $cuerpo = filter_var($_POST['cuerpo'], FILTER_SANITIZE_STRING);
                $fecha = date('y-m-d h:i:s');
            
                $sql = 'INSERT INTO mensaje (asunto, cuerpo, fecha, id_usuario, username_usuario) values(?,?,?,?,?)';
                $sth = $dbh->prepare($sql);
                $resultado = $sth->execute(array($asunto, $cuerpo, $fecha, $id_usuario, $username_usuario));
            ...
            <div class="container align-items-center">
                <div class="container mt-4">
                    <div class="alert alert-success" role="alert">
                        <p><b>Mensaje enviado con éxito. Puedes comprobarlo en la pestaña Foro.</b></p>
                    </div>
                </div>
                <a href="./mensajes.php" class="btn btn-outline-secondary">Escribir otro mensaje</a>
                <a href="./foro.php" class="btn btn-outline-secondary">Ir a Foro</a>
            </div>
        </section>
    </main>
